...
//
//       assertEquals("1", testList.get(1).getRedPlayerName());
//       assertEquals("2",testList.get(1).getBlackPlayerName());
//
//
//       assertEquals("1", testList.get(2).getRedPlayerName());
//       assertEquals("3",testList.get(2).getBlackPlayerName());
//
//       assertEquals("1",testList.get(3).getRedPlayerName());
//       assertEquals("3",testList.get(3).getBlackPlayerName());
//
//       assertEquals("2", testList.get(4).getRedPlayerName());
//       assertEquals("3",testList.get(4).getBlackPlayerName());
//
//       assertEquals("2",testList.get(5).getRedPlayerName());
//       assertEquals("3",testList.get(5).getBlackPlayerName());
//
//
//
//   }
...
//        assertEquals("1",testList.get(5).getRedPlayerName());
//        assertEquals("4",testList.get(5).getBlackPlayerName());
//
//
//        assertEquals("2", testList.get(6).getRedPlayerName());
//        assertEquals("3",testList.get(6).getBlackPlayerName());
//        assertEquals("2",testList.get(7).getRedPlayerName());
//        assertEquals("3",testList.get(7).getBlackPlayerName());
//
//        assertEquals("2", testList.get(8).getRedPlayerName());
//        assertEquals("4",testList.get(8).getBlackPlayerName());
//        assertEquals("2",testList.get(9).getRedPlayerName());
//        assertEquals("4",testList.get(9).getBlackPlayerName());
//
//        assertEquals("3", testList.get(10).getRedPlayerName());
//        assertEquals("4",testList.get(10).getBlackPlayerName());
//        assertEquals("3",testList.get(11).getRedPlayerName());
//        assertEquals("4",testList.get(11).getBlackPlayerName());
//
//
//
//    }
...
//
//       // System.out.println(game.getRedPlayerName());
